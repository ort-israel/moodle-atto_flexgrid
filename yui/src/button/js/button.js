...
var pull_right = M.util.get_string('thisdirection', 'langconfig') === 'rtl' ? 'pull-right' : '';
...
var col2_template =
    ...
    '<div class="row-fluid">' +
    '<div class="col-md-6 span6' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-6 span6' + pull_right + '"><p>' + M.util.get_string('column2', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';
var col3_template =
    '<div class="atto_bsgrid container-fluid">' +
    '<div class="row-fluid">' +
    '<div class="col-md-4 span4' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-4 span4' + pull_right + '"><p>' + M.util.get_string('column2', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-4 span4' + pull_right + '"><p>' + M.util.get_string('column3', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';
...
var col1x3_template =
    ...
    '<div class="row-fluid">' +
    '<div class="col-md-4 span4' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-8 span8' + pull_right + '"><p>' + M.util.get_string('column2', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';
...
var col3x1_template =
    '<div class="atto_bsgrid container-fluid">' +
    '<div class="row-fluid">' +
    '<div class="col-md-8 span8' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-4 span4' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';
...
var col4_template =
    '<div class="atto_bsgrid container-fluid">' +
    '<div class="row-fluid">' +
    '<div class="col-md-3 span3' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-3 span3' + pull_right + '"><p>' + M.util.get_string('column2', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-3 span3' + pull_right + '"><p>' + M.util.get_string('column3', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-3 span3' + pull_right + '"><p>' + M.util.get_string('column4', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';
...
var col6_template =
    '<div class="atto_bsgrid container-fluid">' +
    '<div class="row-fluid">' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column1', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column2', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column3', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column4', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column5', 'atto_bsgrid') + '</p></div>' +
    '<div class="col-md-2 span2' + pull_right + '"><p>' + M.util.get_string('column6', 'atto_bsgrid') + '</p></div>' +
    '</div>' +
    '</div>';

var templates = {
    col2: {template: col2_template, icon: "col2", title: M.util.get_string('col2', 'atto_bsgrid')},
